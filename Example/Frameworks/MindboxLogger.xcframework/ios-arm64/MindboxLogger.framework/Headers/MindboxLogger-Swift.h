...
#ifndef MINDBOXLOGGER_SWIFT_H
#define MINDBOXLOGGER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MindboxLogger",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC13MindboxLogger12CDLogMessage")
@interface CDLogMessage : NSManagedObject
- (nonnull instancetype)initWithEntity:(NSEntityDescription * _Nonnull)entity insertIntoManagedObjectContext:(NSManagedObjectContext * _Nullable)context OBJC_DESIGNATED_INITIALIZER;
@end

@class NSDate;
@class NSString;
@interface CDLogMessage (SWIFT_EXTENSION(MindboxLogger))
...
SWIFT_CLASS("_TtC13MindboxLogger21MBPersistentContainer")
@interface MBPersistentContainer : NSPersistentContainer
