...
final class TimeIntervalTimeSpanTests: XCTestCase {
    ...
    func test_toTimeSpan_zero() {
        ...
        XCTAssertEqual(result, "00:00:00.0000000")
    }

    func test_toTimeSpan_subSecondValues() {
        let cases: [(TimeInterval, String)] = [
            (0.1,       "00:00:00.1000000"),
            (0.001,     "00:00:00.0010000"),
            (0.1234567, "00:00:00.1234567"),
            (0.4567890, "00:00:00.4567890"),
        ]
    ...
    func test_toTimeSpan_secondsAndMinutes() {
        let cases: [(TimeInterval, String)] = [
            (1.0,    "00:00:01.0000000"),
            (59.0,   "00:00:59.0000000"),
            (60.0,   "00:01:00.0000000"),
            (61.5,   "00:01:01.5000000"),
            (3599.0, "00:59:59.0000000"),
        ]
    ...
    func test_toTimeSpan_hours() {
        let cases: [(TimeInterval, String)] = [
            (3600.0,  "01:00:00.0000000"),
            (7261.0,  "02:01:01.0000000"),
    ...
    func test_toTimeSpan_typicalSDKProcessingTimes() {
        XCTContext.runActivity(named: "50ms processing time") { _ in
            XCTAssertEqual(TimeInterval(0.05).toTimeSpan(), "00:00:00.0500000")
        }

        XCTContext.runActivity(named: "250ms processing time") { _ in
            XCTAssertEqual(TimeInterval(0.25).toTimeSpan(), "00:00:00.2500000")
        }

        XCTContext.runActivity(named: "1.5s processing time") { _ in
            XCTAssertEqual(TimeInterval(1.5).toTimeSpan(), "00:00:01.5000000")
        }

        XCTContext.runActivity(named: "5s processing time") { _ in
            XCTAssertEqual(TimeInterval(5.0).toTimeSpan(), "00:00:05.0000000")
        }
    }
}
