...
//        let config = InAppConfigutationMapper(customerSegmentsAPI: .live, inAppsVersion: 1)
//            
...
//        let response = try getConfigWithTwoInapps()
//        let config = InAppConfigutationMapper(customerSegmentsAPI: .live, inAppsVersion: 2)
...
//        let expectation = self.expectation(description: "test_invalisInApps")
//        let _ = InAppConfigutationMapper(customerSegmentsAPI: .live, inAppsVersion: 2)
